...
class VideoFrameHandler:
    def __init__(self):
        ...
        #self.df = pd.DataFrame(columns=['timestamp', 'EAR', 'MAR', 'eye_shut_counter', 'yawn_counter', 'alarm_on'])
        self.row_dict={}
    ...
    def process(self, frame: np.array, thresholds: dict):
        ...
        if results.multi_face_landmarks:
            ...
            #self.df = pd.concat([self.df, pd.DataFrame.from_records([{"timestamp": current_time, "EAR": EAR, "MAR": MAR, "eye_shut_counter": self.eye_shut_counter, "yawn_counter": self.yawn_counter, "alarm_on": alarm_on}])], ignore_index=True)
            self.row_dict={"timestamp": current_time, "EAR": EAR, "MAR": MAR, "eye_shut_counter": self.eye_shut_counter, "yawn_counter": self.yawn_counter, "alarm_on": alarm_on}
